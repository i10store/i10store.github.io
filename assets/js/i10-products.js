...
const rows = [
  ...
  ["Ghi chú", product["NOTE"] || "Không có"]
        ...
        relatedWrap.innerHTML = `
          <div style="font-weight:800;font-size:14px;color:#222;padding:6px 12px 6px 12px;border-bottom:1px solid #eee;background: #faf7ea;">Sản phẩm khác:</div>
        ...
        if (window.innerWidth < 768) {
          ...
          relatedWrap.querySelector('.related-product-list').style.cssText = 'display:flex;flex-direction:row;gap:8px;padding:5px;overflow-x:auto;overflow-y:hidden;max-height:calc(18vh - 8px);white-space:nowrap;';
